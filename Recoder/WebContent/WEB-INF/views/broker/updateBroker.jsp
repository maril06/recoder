...
<jsp:include page="../common/header.jsp"></jsp:include> 
    ...
    <div class="c1">
       ...
       <div class="c2">
          ...
          <c:set var="address" value="${fn:split(broker.brokerAddr , ',' ) }"/>
          <form class="membersignup" method="post" action="${contextPath}/broker/updateBrokerServlet.do" onsubmit="return validateMember();">  <!-- onsubmit="return validateMember();"> -->
             ...
             <div class="postcodeArea">
							<input type="text" name="post" class="form-control postcodify_postcode5 username addr" id="postcode" value="${address[0]}">
							<button type="button" class="btn btn-primary small" id="postcodify_search_button">검색</button>
						</div>

							<input type="text" class="form-control postcodify_address username addr" name="address1" id="address1" value="${address[1]}">

							<input type="text" class="form-control postcodify_details username addr" name="address2" id="address2" value="${address[2]}">
...
<script> $(function() { $("#postcodify_search_button").postcodifyPopUp(); }); </script>
	...
	<script src="${contextPath}/resources/js/memberUpdate2.js"></script>
</body>
</html>